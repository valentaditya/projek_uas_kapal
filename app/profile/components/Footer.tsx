...
export default function ProfileFooter() {
  return (
    <footer className="w-full bg-[#0d1321] py-6 px-10 border-t border-white/5 flex items-center justify-center lg:justify-between text-white mt-auto">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 md:gap-8 text-[11px] text-gray-500 mr-10 tracking-wide">
